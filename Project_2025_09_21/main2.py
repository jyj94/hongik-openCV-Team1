...
class CrosswalkSign():
    def __init__(self, signWidget, LCDWidget, startCount=10, blinkInterval=500):
        ...
        self.greenLightOnImg = QPixmap('/home/inteee/opencvZoo2/새 폴더 (2)/img/greenLightOn.png')
        self.greenLightOffImg = QPixmap('/home/inteee/opencvZoo2/새 폴더 (2)/img/greenLightOff.png')
        self.redLightImg = QPixmap('/home/inteee/opencvZoo2/새 폴더 (2)/img/redLight.png')
...
class MainWindow():
    def __init__(self):
        ...
        uiFile = QFile('/home/inteee/opencvZoo2/새 폴더 (2)/mainWindow.ui')
    ...
    def nextFrame(self, ret = None, frame = None):
        ...
        if hasattr(self, 'crosswalk_detector'):
            ...
            # 디버깅용
            print("Crosswalk points:", crosswalk_point)
        else:
            frame2 = frame1
            crosswalk_point = None

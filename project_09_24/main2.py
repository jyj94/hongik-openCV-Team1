...
from PySide6.QtWidgets import QApplication, QPushButton, QFileDialog, QMessageBox, QTextEdit
...
class MainWindow():
    def __init__(self):
        ...
        uiFile = QFile('/home/ab123/opencvZoo2/project_09_24/GUI/mainWindow.ui')
        ...
        self.effect.setSource(QUrl.fromLocalFile("/home/ab123/opencvZoo2/project_09_24/data/Sound/경고음.wav"))

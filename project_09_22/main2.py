...
class CrosswalkSign():
    def __init__(self, signWidget, LCDWidget, startCount=10, blinkInterval=500):
        ...
        self.greenLightOnImg = QPixmap('/home/ab123/opencvZoo2/project_09_21/data/GUI_image/greenLightOn.png')
        self.greenLightOffImg = QPixmap('/home/ab123/opencvZoo2/project_09_21/data/GUI_image/greenLightOff.png')
        self.redLightImg = QPixmap('/home/ab123/opencvZoo2/project_09_21/data/GUI_image/redLight.png')
...
class MainWindow():
    def __init__(self):
        ...
        uiFile = QFile('/home/ab123/opencvZoo2/project_09_21/GUI/mainWindow.ui')
    ...
    def nextFrame(self, ret = None, frame = None):
        ...
        if hasattr(self, 'vehicle_detector'):
            ...
            if int(len(crosswalk_point1)) > 0:
                frame3 = self.vehicle_detector.detect_vehicle(frame2, crosswalk_point1)
